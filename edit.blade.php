    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="alamat" id="alamat" class="form-control" value="{{ $mahasiswa->alamat ?? old('alamat') }}"> <br>
            </div>
        </div>
        ...
        <footer class="card-footer text-right">
            <button class="btn btn-w-lg btn-primary" type="sumbit">Simpan</button>
